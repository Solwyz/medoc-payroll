      ...
      <div className="bg-[#FFFFFF] p-4">
        <div className="flex justify-between items-center">
          <div>
            ...
            <div className="text-[12px] text-[#7E7E7E] font-normal mt-2">
              Find all employees payroll below
            </div>
          </div>
         <Link to="/payrun/payrollform">
        ...
        <div className="mt-6 flex">
          <div className="border border-[#D5D5D5] px-6 py-4 rounded-lg">
            ...
            <div className="mt-4 flex">
              <div className="pt-4 pr-8">
                <div className="text-[24px] font-medium text-[#2B2342]">
                  AED 245625.25
                </div>
                <div className="text-[14px] text-[#87898E] mt-2">
                  PAYROLL COST
                </div>
              </div>
          ...
          <div className="ml-4 border border-[#D5D5D5] px-7 py-4 rounded-lg text-center">
            <div className="text-[16px] font-medium text-[#868686]">
              PAY DAY
            </div>
            <div className="text-[24px] text-[#2B2342] font-medium mt-4">
              31 Jan 2025
            </div>
          ...
          <div className="flex gap-2">
            <div className="border flex items-center px-4 py-[10px] rounded-3xl">
              ...
              <input
                ...
                className="focus:outline-none text-[12px] ml-2"
              />
            </div>
